  ...
  return (
    <div className="min-h-screen bg-[#F4F1EA] dark:bg-[var(--color-bg)] text-[#2b2f23] dark:text-[var(--color-text)] selection:bg-[#2b2f23] dark:selection:bg-[var(--color-text)] selection:text-stone-50 dark:selection:text-[var(--color-bg)]">
      ...
      <Container size="sm" className="relative z-10 flex min-h-[80vh] flex-col items-center justify-center text-center">
        ...
        >
          {/* Torn-edge card */}
          <div className="bg-[#FCFAF7] dark:bg-[var(--color-card)] p-12 border border-stone-200 dark:border-[var(--color-border)]" style={tornEffect}>
            <div className="mx-auto mb-8 flex h-20 w-20 items-center justify-center border-4 border-[#2b2f23] dark:border-[var(--color-text)]">
              <Eye size={40} className="text-[#2b2f23] dark:text-[var(--color-text)]" />
            </div>
