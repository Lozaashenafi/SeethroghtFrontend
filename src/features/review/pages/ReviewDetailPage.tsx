...
function SubRating({ label, rating }: { label: string; rating: number | null }) {
  ...
  return (
    <div className="flex items-center justify-between gap-4 py-2 border-b border-stone-200 dark:border-[var(--color-border)] last:border-0">
      <span className="text-xs font-mono uppercase tracking-wider text-stone-500 dark:text-[var(--color-text-secondary)]">{label}</span>
      ...
      <Container size="md" className="relative z-10 py-16">
        ...
        <div className="bg-[#FCFAF7] dark:bg-[var(--color-card)] p-8 border border-stone-200 dark:border-[var(--color-border)] mb-8" style={{ ...tornEffect, ...cardShadow }}>
          ...
          <div className="mb-6 p-4 border border-stone-200 dark:border-[var(--color-border)] bg-white dark:bg-[var(--color-surface)]">
            <p className="text-[10px] font-black uppercase tracking-widest text-stone-500 dark:text-[var(--color-text-secondary)] mb-2">
              Break Down
            </p>
          ...
          <div className="flex items-center justify-between">
            <div className="flex items-center gap-6">
              <span className="text-xs font-mono uppercase text-stone-500 dark:text-[var(--color-text-secondary)]">Was this helpful?</span>
              <button
                onClick={() => handleVote('helpful')}
                disabled={vote.isPending}
                className="flex items-center gap-2 font-black text-xs uppercase tracking-wider text-stone-500 dark:text-[var(--color-text-secondary)] hover:text-emerald-700 dark:hover:text-emerald-400 disabled:opacity-50 transition-colors"
              >
              ...
              <button
                ...
                disabled={vote.isPending}
                className="flex items-center gap-2 font-black text-xs uppercase tracking-wider text-stone-500 dark:text-[var(--color-text-secondary)] hover:text-orange-700 dark:hover:text-orange-400 disabled:opacity-50 transition-colors"
              >
            ...
            <div className="flex gap-3">
              <div className="flex-1 border-2 border-[#2b2f23] dark:border-[var(--color-text)] bg-white dark:bg-[var(--color-surface)]">
                <input
                  ...
                  className="w-full px-4 py-3 text-sm font-black uppercase tracking-wider outline-none bg-transparent dark:placeholder-[var(--color-text-secondary)]"
