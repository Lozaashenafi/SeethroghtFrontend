...
import { register, googleSignIn } from '@/services/userAuth.service';
      ...
      <Container size="sm" className="relative z-10 py-16">
        ...
        <header className="mb-10">
          ...
          <p className="mt-2 text-sm text-stone-500 dark:text-[var(--color-text-secondary)]">
            Join to share verified, anonymous workplace reviews.
          </p>
        </header>
          ...
          <form onSubmit={handleSubmit} className="space-y-5">
            <div>
              ...
              <input
                ...
                placeholder="Your name (only for your account)"
              />
              <p className="mt-1 text-[10px] text-stone-400 dark:text-[var(--color-text-secondary)]">
                This is only for your account — it will never be shown on reviews.
              </p>
            </div>
        ...
        <p className="mt-6 text-center text-xs text-stone-500 dark:text-[var(--color-text-secondary)]">
          ...
          <Link
            to={`${ROUTES.LOGIN}${redirectTo !== ROUTES.HOME ? `?redirect=${encodeURIComponent(redirectTo)}` : ''}`}
