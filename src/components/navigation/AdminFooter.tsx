        ...
        <div className="grid gap-10 md:grid-cols-2 lg:grid-cols-3">
          ...
          <div>
            <div className="mb-4 flex items-center gap-2">
              ...
              <span className="text-xl font-black uppercase tracking-tighter text-[var(--color-text)] dark:text-[var(--color-text)]">
                Admin Console
              </span>
            </div>
            ...
            <Link
              to={ROUTES.HOME}
              className="mt-5 inline-flex items-center gap-2 border-2 border-[var(--color-text)] bg-[var(--color-text)] px-4 py-2.5 text-[10px] font-black uppercase tracking-widest text-white transition-all hover:opacity-90 active:translate-y-0.5 dark:border-[var(--color-text)] dark:bg-[var(--color-text)] dark:text-[var(--color-bg)]"
            >
          ...
          {/* Section links */}
          <div>
            <h3 className="mb-5 border-b border-[var(--color-text)]/20 pb-2 text-[10px] font-black uppercase tracking-[0.2em] text-[var(--color-text)] dark:border-[var(--color-border)] dark:text-[var(--color-text)]">
              Sections
            </h3>
              ...
              {adminQuickLinks.map((link) => {
                ...
                return (
                  <li key={link.href}>
                    <Link
                      to={link.href}
                      className="group flex items-center gap-2 text-xs font-mono font-bold uppercase text-stone-500 transition-colors hover:text-[var(--color-text)] dark:text-[var(--color-text-secondary)] dark:hover:text-[var(--color-text)]"
                    >
                      <Icon
                        size={13}
